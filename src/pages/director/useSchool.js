...
export const useCreateTeacher = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: QK.users('teacher') }); qc.invalidateQueries({ queryKey: QK.userStats }); toast.success('Teacher account created.'); },
    onError: (e) => toast.error(e.response?.data?.message || 'Failed.'),
  });
};
...
export const useCreateStudent = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: QK.users('student') }); qc.invalidateQueries({ queryKey: QK.userStats }); toast.success('Student account created.'); },
    onError: (e) => toast.error(e.response?.data?.message || 'Failed.'),
  });
};
...
export const useCreateParent = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: QK.users('parent') }); qc.invalidateQueries({ queryKey: QK.userStats }); toast.success('Parent account created.'); },
    onError: (e) => toast.error(e.response?.data?.message || 'Failed.'),
  });
};
...
export const useDeactivateUser = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['users'] }); qc.invalidateQueries({ queryKey: QK.userStats }); toast.success('User deactivated.'); },
    onError: (e) => toast.error(e.response?.data?.message || 'Failed.'),
  });
};
...
export const useEnrollStudent = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['users'] }); toast.success('Student enrolled.'); },
    onError: (e) => toast.error(e.response?.data?.message || 'Failed.'),
  });
};
