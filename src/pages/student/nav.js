import { LayoutDashboard, User, CalendarDays, BookOpen, Award, CheckSquare, Trophy, Video, BookMarked , GraduationCap, ClipboardCheck, Sparkles } from 'lucide-react';
export const STUDENT_NAV = [
  ...
  { to: '/student/study-helper', label: 'AI Study Helper', icon: Sparkles },
